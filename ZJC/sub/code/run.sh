...
python3 main.py \
        ...
        --dem_nfold 2 --dem_batch_size 128 --dem_epochs 2 --dem_ensemble_nfold 2 --dem_patience 10 --zs_model_type RES_DEM_BC \
        ...
        --only_emb False --train_ft True --ft_model skipgram --ft_size 10 --pixel 64 \
        --ft_threads 12 --ft_iter 1 --wv_len 1400 --res_dem_epochs 3 --res_dem_nfold 2 --ft_verbose 2 --ft_lrUpdateRate 10000