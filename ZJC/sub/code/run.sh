...
python3 main.py \
        ...
        --dem_nfold 2 --dem_batch_size 128 --dem_epochs 2 --dem_ensemble_nfold 2 --dem_patience 10 --zs_model_type DEM_AUG \
        ...
        --load_img_model True --predict_flat False --load_zs_model true --TTA 5