...
python3 main.py \
        --input-training-data-path ../data/pix72/ --output-model-path ../submit/ --debug True --train_verbose 2 \
        ...
        --attr_emb_len 30 --only_use_round2 False --attr_emb_transform flat --ft_min_count 5