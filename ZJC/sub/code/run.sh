...
python3 main.py \
        --input-training-data-path ../data/ --output-model-path ../submit/ --debug False --train_verbose 1 \
        ...
        --ft_threads 12 --ft_iter 1 --wv_len 1200 --res_dem_epochs 3 --res_dem_nfold 10